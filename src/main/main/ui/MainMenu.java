...
public class MainMenu extends JPanel {
    ...
    public void doLayout() {
        ...
        title.setFont(DiaryPixel.deriveFont(height / 8f));
        Font buttonFont = SuperJoyful.deriveFont(height / 15f);
        ...
        playButton.setBounds(width/2 - 80, height/2 - 50, 160, 50);
        settingsButton.setBounds(width/2 - 100, height/2 + 5, 200, 50);
        aboutButton.setBounds(width/2 - 80, height/2 + 60, 160, 45);
        exitButton.setBounds(width / 2 - 80, height / 2 + 110, 160, 45);
    }
