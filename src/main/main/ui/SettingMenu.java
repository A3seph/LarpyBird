...
public class SettingMenu extends JPanel {
    ...
    public JCheckBox musicCheck;
    public JCheckBox sfxCheck;
    ...
    public SettingMenu() {
        ...
        //==Music Toggle==
        musicCheck = new JCheckBox("Music On");
        musicCheck.setFont(SuperJoyful);
        musicCheck.setFocusPainted(false);
        musicCheck.setSelected(true);
        add(musicCheck);

        //==SFX Toggle==
        sfxCheck = new JCheckBox("Sound Effects On");
        sfxCheck.setFont(SuperJoyful);
        sfxCheck.setFocusPainted(false);
    ...
    public void doLayout() {
        ...
        musicCheck.setBounds(width / 2 - 80, height / 2 - 60, 160, 30);
        sfxCheck.setBounds(width / 2 - 80, height / 2 - 20, 160, 30);
