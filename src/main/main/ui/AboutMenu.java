...
public class AboutMenu extends JPanel {
    ...
    static final DeveloperInfo[] DEVELOPERS = {
            new DeveloperInfo("BORROMEO, Allen Joseph (Leader (Lead programmer))", "/images/allen.png", "/sounds/allendorya.wav"),
            new DeveloperInfo("BULAN, Elijah", "/images/elijah.png", "/sounds/elijah.wav"),
            new DeveloperInfo("BOX, Gabriel Alexander (Game Designer)", "/images/gabriel.png", "/sounds/gabriel.wav"),
            new DeveloperInfo("ARADO, Kelly (Documenter)", "/images/kelly.png", "/sounds/kelly.wav"),
            new DeveloperInfo("CANILLO, Erns", "/images/erns.png", "/sounds/erns.wav"),
            new DeveloperInfo("PANSACALA, Ernesto (Sound Designer)", "/images/ernesto.png", "/sounds/ernesto.wav")
    };
