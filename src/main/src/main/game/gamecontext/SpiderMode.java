...
public class SpiderMode implements GameMode {
    ...
    //Sound effects
    private final String switchSoundPath = "/sounds/TpSpider.wav";
    ...
    // Centered, layered game-over screen (title / score / restart, stacked and centered)
    private void drawGameOverLayer(Graphics2D g, GameContext ctx) {
        ...
        g.drawString(title, titleX, centerY - 20);
        ...
        g.drawString(scoreLine, scoreX, centerY + 10);
        ...
        g.drawString(restartLine, restartX, centerY + 35);
    }
